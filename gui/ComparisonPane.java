...
public class ComparisonPane extends JPanel implements ChangeListener{
  ...
  public ComparisonPane(Criterium c, int i, int j, boolean last,CriteriumShowPanel csp,AHPEngine window2) {
	...
	*/
      ...
      //slide = new JSlider (new DefaultBoundedRangeModel((int) (c.getP()).get(i,j) , 2, -8,8));
